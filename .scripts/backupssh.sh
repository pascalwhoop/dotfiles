...
sudo rsync --force --delete -vaxHAX --info=progress2 --filter="merge /home/pascalwhoop/.config/rsync/backup_inc_exc.txt" $1 / /run/media/pascalwhoop/5821102c-0831-4cb9-ba41-46b359300432/backup 
